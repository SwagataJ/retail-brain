...
# 2. Train the forecasting model & generate 30-day predictions
...
```bash
python scripts/train_forecast.py      # Train model & evaluate on holdout
python scripts/predict_forecast.py    # Generate 30-day predictions
```
